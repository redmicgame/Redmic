    ...
    useEffect(() => {
        const generateSummary = async () => {
            ...
            try {
                ...
                const labelInfo = release.releasingLabel ? `under ${release.releasingLabel.name}${release.releasingLabel.dealWithMajor ? ` via ${release.releasingLabel.dealWithMajor}` : ''}` : 'independently';
