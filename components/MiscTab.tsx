    ...
    return (
        <>
            ...
            <div className="space-y-6">
                ...
                <div className="bg-zinc-800 p-4 rounded-lg">
                    <h3 className="font-bold text-lg mb-2">Manage Save Data</h3>
                    <button onClick={() => setShowExportOptions(true)} className="w-full bg-blue-900/50 p-3 rounded-lg text-left text-blue-300 hover:bg-blue-900 transition-colors flex justify-between items-center">
                        <span>Download Save File</span>
                    </button>
                    <p className="text-xs text-zinc-500 mt-2">Download your game progress as a file to manually back it up or transfer it to another device.</p>
                </div>
